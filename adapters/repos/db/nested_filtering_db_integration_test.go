...
func TestNestedFilteringIsNullStandalone(t *testing.T) {
	...
	t.Run("nested_object", func(t *testing.T) {
		...
		// address), idMixedCities (cars[1] empty), idAddrWithTags (tags-only
		// address has no city), idMixedTagsAndCities (city in [0], tags in
		// [1], empty in [2] — [1] and [2] qualify). Vacuous matches
